...
![](https://github.com/suhaskol/Money-Ball/blob/master/Image1.PNG)


## Data

We'll be using data from Sean Lahaman's Website a very useful source for baseball statistics. The documentation for the csv files is located in the readme2013.txt file. We may need to reference this to understand what acronyms stand for.
There are two datasets, “Batting.csv” and “salary.csv” included in the repository to work on. 

## Procedure: 

Here the code is provided in “Moneyball.R”. Each step with comments are provided. 
The code should be understood in such a way that, each line after written should be executed, then analyze the dataset obtained and next steps decided. The final result has variable solutions depending on the way we execute the things. However, I have executed a method but again can have multiple solutions.
